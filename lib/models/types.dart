...
class Protocol {
  ...
  static get values => [HTTP, HTTPS, FILE, UDP, TCP, RTMP, RTMPS, RTMPT, RTMPE, RTMFP, DEV, RTSP, RTP, SRT];
  ...
  static const Protocol RTMPT = Protocol._('rtmpt');
  static const Protocol RTMPE = Protocol._('rtmpe');
  static const Protocol RTMFP = Protocol._('rtmfp');
